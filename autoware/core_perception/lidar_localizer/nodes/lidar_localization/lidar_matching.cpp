...
static void points_callback(const sensor_msgs::PointCloud2::ConstPtr& input) {
  ...
  if (map_loaded == 1 && init_pos_set == 1) {
    ...
    */
    ...
    localizer_pose_pub.publish(
        localizer_pose_msg);  // pub-topic: "/localizer_pose"  trans
    ...
    if (_use_local_transform == true) {
      ...
      br.sendTransform(
          tf::StampedTransform(transform, current_scan_time, "/map",
                               "/base_link"));  // ndt_pose result map/base_link
    }
