...
namespace mapping{
  struct GPSCostFunction{
    ...
    bool operator()(const T* tj, T* residuals )const{
        ...
        // LOG(INFO)<<"gps-cost func     -tj:["<<tj[0]<<", "<<tj[1]<<", "<<tj[2]<<"]";
        // LOG(INFO)<<"gps-cost func-default:["<<x_<<", "<<y_<<", "<<z_<<"]";
        // LOG(INFO)<<"gps-cost    residuals:["<<residuals[0]<<", "<<residuals[1]<<", "<<residuals[2]<<"]";
        return true;
    }
  ...
  struct OdomCostFunction{
    ...
    bool operator()(const T* w_q_i, const T *ti, //t1  i  pose of gps
        ...
        // LOG(INFO)<<"odom-cost func-default:["<<tf_x_<<", "<<tf_y_<<", "<<tf_z_<<"]";
        T w_q_i_inverse[4];
        ...
        // LOG(INFO)<<"odom-cost   residuals:["<<residuals[0]<<", "<<residuals[1]<<", "<<residuals[2]<<"]";
